...
CountViz.prototype.initVis = function(){
    ...
    // DONE: modify this to append an svg element, not modify the current placeholder SVG element
...
*/
CountViz.prototype.wrangleData= function(){
...
CountViz.prototype.updateVis = function(){
    ...
    this.xScale.domain( d3.extent( this.data, function( d ) { return d.time; } ) );
    this.yScale.domain( [ 0, d3.max( this.data, function( d ) { return d.count; } ) ] );
 ...
 * @param selection
 */
CountViz.prototype.onSelectionChange= function (selectionStart, selectionEnd){
 ...
 */
CountViz.prototype.addSlider = function( svg ){
    ...
    sliderScale.domain( [ d3.max( this.data, function( d ) { return d.count; } ), 0 ] );
    sliderScale.range( [ 0, this.height ] );
